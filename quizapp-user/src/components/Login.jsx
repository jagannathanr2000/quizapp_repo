...
const Login = () => {
  ...
  return (
      ...
      <div className="w-96 h-96 bg-slate-100 max-w-md p-8 space-y-3 rounded-lg shadow-md">
        <h1 className="text-2xl font-md text-center text-black">Login</h1>
        ...
        <p className='text-black text-sm'>New to our platform? <a className="text-blue-800 underline" href="/register">Create an account</a></p>
      </div>
